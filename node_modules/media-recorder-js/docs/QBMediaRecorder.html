...
<dl class="details">
    ...
    <dd class="tag-see">
        <ul>
            <li>For record 'audio/mp3' need to connect encoderMP3 (just connect <a href="https://www.npmjs.com/package/lamejs">'lame.all.js'</a> or <a href="https://www.npmjs.com/package/lamejs">'lame.min.js'</a> file to global environment) before init QBMediaRecorder.</li>
        </ul>
    </dd>
...
<span class="param-type">function</span>
    ...
    <h4 class="name" id=".isAvailable"><span class="type-signature">(static) </span>isAvailable<span class="signature">()</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<span class="param-type">Boolean</span>
    ...
    <h4 class="name" id=".isTypeSupported"><span class="type-signature">(static) </span>isTypeSupported<span class="signature">(mimeType)</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<span class="param-type">Boolean</span>
    ...
    <h4 class="name" id=".getSupportedMimeTypes"><span class="type-signature">(static) </span>getSupportedMimeTypes<span class="signature">(type<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Array}</span></h4>
...
<span class="param-type">String</span>
    ...
    <h4 class="name" id="start"><span class="type-signature"></span>start<span class="signature">(stream)</span><span class="type-signature"> &rarr; {void}</span></h4>
...
<span class="param-type">void</span>
    ...
    <h4 class="name" id="stop"><span class="type-signature"></span>stop<span class="signature">()</span><span class="type-signature"> &rarr; {Blob}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="index.js.html">index.js</a>, <a href="index.js.html#line483">line 483</a>
    </li></ul></dd>
...
<span class="param-type">void</span>
    ...
    <h4 class="name" id="resume"><span class="type-signature"></span>resume<span class="signature">()</span><span class="type-signature"> &rarr; {void}</span></h4>
...
<span class="param-type">void</span>
    ...
    <h4 class="name" id="change"><span class="type-signature"></span>change<span class="signature">(stream)</span><span class="type-signature"> &rarr; {void}</span></h4>
...
<span class="param-type">void</span>
    ...
    <h4 class="name" id="download"><span class="type-signature"></span>download<span class="signature">(fileName<span class="signature-attributes">opt</span>, blob<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {void}</span></h4>
...
<footer>
    Documentation generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 3.4.3</a> on Tue Mar 07 2017 14:24:48 GMT+0200 (Финляндия (зима)) using the <a href="https://github.com/clenemt/docdash">docdash</a> theme.
</footer>
